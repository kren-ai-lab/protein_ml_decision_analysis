...
def parse_args():
    ...
    parser.add_argument("--normalize", action="store_true", help="Apply L2 normalization to embedding features before analysis.")
...
def main():
    ...
    # -----------------------------
    if args.normalize:
        print("[INFO] Applying L2 normalization to embedding features.")
        X_used = normalize(X, norm="l2")
    else:
        print("[INFO] Using raw embedding features without normalization.")
        X_used = X
